...
• Check document has at least one page`
  ...
  server.tool(
    "preview_document",
    "🔍 **ESSENTIAL VALIDATION STEP**: Generate visual previews to verify your layout matches the reference image. Use this tool AFTER creating your initial layout and BEFORE finalizing your work.\n\n**RECOMMENDED WORKFLOW**:\n1. Create initial layout with frames and text\n2. 🔄 Call preview_document (quality: 'medium') \n3. 📋 Compare preview against reference image\n4. ✏️ Make adjustments if needed\n5. 🔄 Generate final preview to confirm accuracy\n6. ✅ Complete session\n\n**QUALITY GUIDE**: Use 'medium' quality for iteration, 'high' for final validation. Essential for catching font sizing, positioning, and spacing issues early.\n\n**EXAMPLES**:\n• Quick iteration: `{quality: \"preview\"}` (72dpi, ~1-2 seconds)\n• Validation check: `{quality: \"medium\", page: 2}` (150dpi for review)\n• Final verification: `{quality: \"high\"}` (300dpi for accuracy)\n\n**RESULTS**: Returns file path to generated PNG preview, enables visual validation of design changes, supports iterative design workflows with immediate feedback.",
    {
